import subprocess # menjalankan code bahasa lain di python
import argparse # membuat user command line interface
from pathlib import Path # untuk mengatur file path di sistem operasi

from joblib import Parallel, delayed # membuat pipeline python ringan
...
if __name__ == '__main__': # statement langsung menjalankan code python sebagai utama
